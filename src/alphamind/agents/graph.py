...
both specialists must complete before synthesis runs. Sentiment and
technical specialists land in later PRs and slot into the same fan-out.
...
def build_research_graph(
    *,
    ...
    # signature under strict mypy. Suppression is scoped to these five
    ...
    graph.add_conditional_edges(
        "router",
        _route_specialists,
        {"fundamentals": "fundamentals", "risk": "risk"},
    )
